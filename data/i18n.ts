...
export const dictionary = {
  tr: {
    ...
    home: {
      ...
      shopTitle: "Günlük stil için seçilmiş ürünler",
      shopDescription: "Sepet, varyasyon, kampanya ve çok satanlar bölümleri için hazır ürün mimarisi.",
      bestsellersTitle: "Instagram'da sevilen modeller",
      bestsellersNote: "Renk, beden, baskı ve adet varyasyonları sonraki ürün kataloğuna bağlanabilir.",
      toteTitle: "Kafe, butik ve günlük şehir hayatı için.",
      toteDescription: "Minimal baskı, doğal kumaş hissi, Instagram'a uygun ürün hikayesi.",
      growthTitle: "Bugünün vitrini, yarının e-ticaret altyapısı",
      growthDescription: "Kategori, ürün, görsel ve teklif akışı şimdiden ölçeklenebilir şekilde ayrıldı.",
      growthFeatures: ["Sepet sistemi", "Ürün varyasyonları", "Çok satanlar", "Kampanyalar", "Çoklu dil", "WhatsApp teklif akışı"],
    },
    cta: {
    ...
    pages: {
      women: {
        title: "Bayan Çorap",
        eyebrow: "Kadın koleksiyonu",
        description: "Bamboo, nakışlı, renkli, ince çorap ve daha fazlası. Bayan çorap koleksiyonumuzu keşfedin.",
        bullets: ["Bamboo çorap", "Nakışlı modeller", "Renkli koleksiyon", "Sneaker ve babet"],
        image: instagramMedia.socks.hero,
        ctaTitle: "Bayan çorap için teklif alın",
        subcategories: [
          { slug: "bamboo", label: "Bamboo" },
          { slug: "diz-alti", label: "Diz Altı" },
          { slug: "diz-ustu", label: "Diz Üstü" },
          { slug: "en-yeniler", label: "En Yeniler" },
          { slug: "ince-corap", label: "İnce Çorap" },
          { slug: "nakisli-corap", label: "Nakışlı Çorap" },
          { slug: "patik", label: "Patik" },
          { slug: "renkli-corap", label: "Renkli Çorap" },
          { slug: "sneaker-ve-babet", label: "Sneaker ve Babet" },
          { slug: "soket", label: "Soket" },
        ],
      },
      men: {
        title: "Erkek Çorap",
        eyebrow: "Erkek koleksiyonu",
        description: "Bambu, desenli, diyabetik, kışlık ve daha fazlası. Erkek çorap koleksiyonumuzu keşfedin.",
        bullets: ["Bambu çorap", "Desenli modeller", "Diyabetik çorap", "Kışlık çorap"],
        image: instagramMedia.socks.wholesale,
        ctaTitle: "Erkek çorap için teklif alın",
        subcategories: [
          { slug: "bambu-corap", label: "Bambu Çorap" },
          { slug: "desenli-corap", label: "Desenli Çorap" },
          { slug: "diyabetik-corap", label: "Diyabetik Çorap" },
          { slug: "kislik-corap", label: "Kışlık Çorap" },
          { slug: "patik-corap", label: "Patik Çorap" },
          { slug: "sneaker-corap", label: "Sneaker Çorap" },
        ],
      },
      kids: {
        title: "Çocuk Çorap",
        eyebrow: "Çocuk koleksiyonu",
        description: "Erkek çocuk, kız çocuk ve taraftar koleksiyonları. Renkli ve eğlenceli çoraplar.",
        bullets: ["Erkek çocuk", "Kız çocuk", "Taraftar", "Renkli modeller"],
        image: instagramMedia.socks.bamboo,
        ctaTitle: "Çocuk çorap için teklif alın",
        subcategories: [
          { slug: "erkek-cocuk", label: "Erkek Çocuk" },
          { slug: "kiz-cocuk", label: "Kız Çocuk" },
          { slug: "taraftar", label: "Taraftar" },
        ],
      },
      socks: {
        title: "Çorap Üretimi",
  ...
  en: {
    ...
    home: {
      ...
      shopTitle: "Curated products for everyday style",
      shopDescription: "Basket, variation, campaign, and bestseller sections — product architecture ready to scale.",
      bestsellersTitle: "Best-loved models on Instagram",
      bestsellersNote: "Color, size, print, and quantity variations can be linked to the next product catalogue.",
      toteTitle: "For cafés, boutiques, and everyday city life.",
      toteDescription: "Minimal print, natural fabric feel, Instagram-ready product story.",
      growthTitle: "Today's storefront, tomorrow's e-commerce backbone",
      growthDescription: "Category, product, visual, and quote flow are already separated for scalable growth.",
      growthFeatures: ["Cart system", "Product variations", "Bestsellers", "Campaigns", "Multilingual", "WhatsApp quote flow"],
    },
    cta: {
    ...
    pages: {
      women: {
        ...
        description: "Bamboo, embroidered, colorful, sheer socks and more. Explore our women's sock collection.",
        bullets: ["Bamboo socks", "Embroidered styles", "Colorful collection", "Sneaker & ballet"],
        image: instagramMedia.socks.hero,
        ctaTitle: "Get a quote for women's socks",
        subcategories: [
          { slug: "bamboo", label: "Bamboo" },
          { slug: "diz-alti", label: "Ankle" },
          { slug: "diz-ustu", label: "Knee High" },
          { slug: "en-yeniler", label: "New Arrivals" },
          { slug: "ince-corap", label: "Sheer Socks" },
          { slug: "nakisli-corap", label: "Embroidered" },
          { slug: "patik", label: "Slipper Socks" },
          { slug: "renkli-corap", label: "Colorful" },
          { slug: "sneaker-ve-babet", label: "Sneaker & Ballet" },
          { slug: "soket", label: "No-Show" },
        ],
      },
      men: {
        title: "Men's Socks",
        eyebrow: "Men's collection",
        description: "Bamboo, patterned, diabetic, thermal and more. Explore our men's sock collection.",
        bullets: ["Bamboo socks", "Patterned styles", "Diabetic socks", "Thermal socks"],
        image: instagramMedia.socks.wholesale,
        ctaTitle: "Get a quote for men's socks",
        subcategories: [
          { slug: "bambu-corap", label: "Bamboo" },
          { slug: "desenli-corap", label: "Patterned" },
          { slug: "diyabetik-corap", label: "Diabetic" },
          { slug: "kislik-corap", label: "Thermal" },
          { slug: "patik-corap", label: "Slipper Socks" },
          { slug: "sneaker-corap", label: "Sneaker" },
        ],
      },
      kids: {
        title: "Kids' Socks",
        eyebrow: "Kids' collection",
        description: "Boys, girls and fan collections. Colorful and fun socks for kids.",
        bullets: ["Boys", "Girls", "Fan socks", "Colorful styles"],
        image: instagramMedia.socks.bamboo,
        ctaTitle: "Get a quote for kids' socks",
        subcategories: [
          { slug: "erkek-cocuk", label: "Boys" },
          { slug: "kiz-cocuk", label: "Girls" },
          { slug: "taraftar", label: "Fan Socks" },
        ],
      },
      socks: {
  ...
  de: {
    ...
    home: {
      ...
      shopTitle: "Ausgewählte Produkte für den Alltag",
      shopDescription: "Warenkorb, Variationen, Kampagnen und Bestseller — skalierbare Produktarchitektur.",
      bestsellersTitle: "Auf Instagram beliebte Modelle",
      bestsellersNote: "Farbe, Größe, Druck und Mengenvarianten können im nächsten Produktkatalog verlinkt werden.",
      toteTitle: "Für Cafés, Boutiquen und den täglichen Stadtalltag.",
      toteDescription: "Minimaler Druck, natürliches Stoffgefühl, Instagram-taugliche Produktgeschichte.",
      growthTitle: "Heutiges Schaufenster, morgen E-Commerce-Infrastruktur",
      growthDescription: "Kategorie, Produkt, Visuals und Angebotsfluss sind bereits für skalierbares Wachstum getrennt.",
      growthFeatures: ["Warenkorb", "Produktvariationen", "Bestseller", "Kampagnen", "Mehrsprachig", "WhatsApp-Angebote"],
    },
    cta: {
    ...
    pages: {
      women: {
        title: "Damen Socken",
        eyebrow: "Damen-Kollektion",
        description: "Bambus, bestickt, bunt, feine Socken und mehr. Entdecken Sie unsere Damen-Socken-Kollektion.",
        bullets: ["Bambus-Socken", "Bestickte Modelle", "Bunte Kollektion", "Sneaker & Ballerina"],
        image: instagramMedia.socks.hero,
        ctaTitle: "Angebot für Damensocken anfragen",
        subcategories: [
          { slug: "bamboo", label: "Bambus" },
          { slug: "diz-alti", label: "Knöchelsocken" },
          { slug: "diz-ustu", label: "Kniestrümpfe" },
          { slug: "en-yeniler", label: "Neuheiten" },
          { slug: "ince-corap", label: "Feine Socken" },
          { slug: "nakisli-corap", label: "Bestickt" },
          { slug: "patik", label: "Hüttensocken" },
          { slug: "renkli-corap", label: "Bunte Socken" },
          { slug: "sneaker-ve-babet", label: "Sneaker & Ballerina" },
          { slug: "soket", label: "Unsichtbare Socken" },
        ],
      },
      men: {
        title: "Herren Socken",
        eyebrow: "Herren-Kollektion",
        description: "Bambus, gemustert, diabetisch, thermisch und mehr. Entdecken Sie unsere Herren-Socken-Kollektion.",
        bullets: ["Bambus-Socken", "Gemusterte Modelle", "Diabetiker-Socken", "Thermosocken"],
        image: instagramMedia.socks.wholesale,
        ctaTitle: "Angebot für Herrensocken anfragen",
        subcategories: [
          { slug: "bambu-corap", label: "Bambus" },
          { slug: "desenli-corap", label: "Gemustert" },
          { slug: "diyabetik-corap", label: "Diabetiker" },
          { slug: "kislik-corap", label: "Thermosocken" },
          { slug: "patik-corap", label: "Hüttensocken" },
          { slug: "sneaker-corap", label: "Sneaker" },
        ],
      },
      kids: {
        title: "Kindersocken",
        eyebrow: "Kinder-Kollektion",
        description: "Jungen, Mädchen und Fan-Kollektionen. Bunte und lustige Socken für Kinder.",
        bullets: ["Jungen", "Mädchen", "Fan-Socken", "Bunte Modelle"],
        image: instagramMedia.socks.bamboo,
        ctaTitle: "Angebot für Kindersocken anfragen",
        subcategories: [
          { slug: "erkek-cocuk", label: "Jungen" },
          { slug: "kiz-cocuk", label: "Mädchen" },
          { slug: "taraftar", label: "Fan-Socken" },
        ],
      },
      socks: {
