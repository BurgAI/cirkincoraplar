  ...
  tr: {
    ...
    pages: {
      women: {
        ...
        subcategories: [
          { slug: "k-01", label: "Bamboo" },
          { slug: "k-02", label: "Diz Altı" },
          { slug: "k-03", label: "Diz Üstü" },
          { slug: "k-04", label: "En Yeniler" },
          { slug: "k-05", label: "İnce Çorap" },
          { slug: "k-06", label: "Nakışlı Çorap" },
          { slug: "k-07", label: "Patik" },
          { slug: "k-08", label: "Renkli Çorap" },
          { slug: "k-09", label: "Sneaker ve Babet" },
          { slug: "k-10", label: "Soket" },
        ],
      },
      men: {
        title: "Erkek Çorap",
        ...
        subcategories: [
          { slug: "e-01", label: "Bambu Çorap" },
          { slug: "e-02", label: "Desenli Çorap" },
          { slug: "e-03", label: "Diyabetik Çorap" },
          { slug: "e-04", label: "Kışlık Çorap" },
          { slug: "e-05", label: "Patik Çorap" },
          { slug: "e-06", label: "Sneaker Çorap" },
        ],
      },
      kids: {
        title: "Çocuk Çorap",
        ...
        subcategories: [
          { slug: "c-01", label: "Erkek Çocuk" },
          { slug: "c-02", label: "Kız Çocuk" },
          { slug: "c-03", label: "Taraftar" },
        ],
      },
      socks: {
        title: "Çorap Üretimi",
  ...
  en: {
    ...
    pages: {
      women: {
        ...
        subcategories: [
          { slug: "k-01", label: "Bamboo" },
          { slug: "k-02", label: "Ankle" },
          { slug: "k-03", label: "Knee High" },
          { slug: "k-04", label: "New Arrivals" },
          { slug: "k-05", label: "Sheer Socks" },
          { slug: "k-06", label: "Embroidered" },
          { slug: "k-07", label: "Slipper Socks" },
          { slug: "k-08", label: "Colorful" },
          { slug: "k-09", label: "Sneaker & Ballet" },
          { slug: "k-10", label: "No-Show" },
        ],
      },
      men: {
        title: "Men's Socks",
        ...
        subcategories: [
          { slug: "e-01", label: "Bamboo" },
          { slug: "e-02", label: "Patterned" },
          { slug: "e-03", label: "Diabetic" },
          { slug: "e-04", label: "Thermal" },
          { slug: "e-05", label: "Slipper Socks" },
          { slug: "e-06", label: "Sneaker" },
        ],
      },
      kids: {
        title: "Kids' Socks",
        ...
        subcategories: [
          { slug: "c-01", label: "Boys" },
          { slug: "c-02", label: "Girls" },
          { slug: "c-03", label: "Fan Socks" },
        ],
      },
      socks: {
  ...
  de: {
    ...
    pages: {
      women: {
        ...
        subcategories: [
          { slug: "k-01", label: "Bambus" },
          { slug: "k-02", label: "Knöchelsocken" },
          { slug: "k-03", label: "Kniestrümpfe" },
          { slug: "k-04", label: "Neuheiten" },
          { slug: "k-05", label: "Feine Socken" },
          { slug: "k-06", label: "Bestickt" },
          { slug: "k-07", label: "Hüttensocken" },
          { slug: "k-08", label: "Bunte Socken" },
          { slug: "k-09", label: "Sneaker & Ballerina" },
          { slug: "k-10", label: "Unsichtbare Socken" },
        ],
      },
      men: {
        title: "Herren Socken",
        ...
        subcategories: [
          { slug: "e-01", label: "Bambus" },
          { slug: "e-02", label: "Gemustert" },
          { slug: "e-03", label: "Diabetiker" },
          { slug: "e-04", label: "Thermosocken" },
          { slug: "e-05", label: "Hüttensocken" },
          { slug: "e-06", label: "Sneaker" },
        ],
      },
      kids: {
        ...
        subcategories: [
          { slug: "c-01", label: "Jungen" },
          { slug: "c-02", label: "Mädchen" },
          { slug: "c-03", label: "Fan-Socken" },
        ],
      },
      socks: {
